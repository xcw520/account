...
export declare function createScale(dataExtent: number[], option: object | AxisBaseModel): import("./scale/Scale").default<import("zrender/esm/core/types").Dictionary<unknown>>;
